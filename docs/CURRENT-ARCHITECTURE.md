...
| publishing / distribution | Channel、ChannelPrice、Draft、UsePackage、DistributionAttempt、Listing、Collection、AnQiCMS Spike 合同 | 默认路径交付冻结资料并记录经营状态；稳定远端 ID 才有 Listing；Spike 只读本地合同，不含 Connector |
